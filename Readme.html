...
/*# sourceURL=ace/css/ace-dillinger */</style></head>
...
<!-- ngIf: profile.enableWordsCount && !viewSrcMode --><p ng-if="profile.enableWordsCount &amp;&amp; !viewSrcMode" class="words ng-scope">Words: <span class="counter ng-binding" ng-bind="words">47</span></p><!-- end ngIf: profile.enableWordsCount && !viewSrcMode -->
<!-- ngIf: profile.enableCharactersCount && !viewSrcMode --><p ng-if="profile.enableCharactersCount &amp;&amp; !viewSrcMode" class="characters ng-scope">Characters: <span class="counter ng-binding" ng-bind="characters">273</span></p><!-- end ngIf: profile.enableCharactersCount && !viewSrcMode -->
</div>
<div class="g mnone">
...
<div id="editor1" class="g-b g-b--t1of2 split split-editor" style="height: 496px;">
<div id="editor" class="ui-resizable-e ace_editor ace-dillinger ace_focus" style="height: 1400px;"><textarea class="ace_text-input" wrap="off" autocorrect="off" autocapitalize="off" spellcheck="false" style="opacity: 0; left: 241px; top: 56px; height: 28px; width: 7px;"></textarea><div class="ace_gutter" aria-hidden="true"><div class="ace_layer ace_gutter-layer ace_folding-enabled" style="margin-top: 0px; height: 1484px; width: 40px;"><div class="ace_gutter-cell " style="height: 28px;">1<span class="ace_fold-widget ace_start ace_open" style="height: 28px;"></span></div><div class="ace_gutter-cell " style="height: 56px;">2</div><div class="ace_gutter-cell " style="height: 56px;">3</div></div><div class="ace_gutter-active-line" style="top: 28px; height: 56px;"></div></div><div class="ace_scroller" style="left: 41px; right: 0px; bottom: 0px;"><div class="ace_content" style="margin-top: 0px; width: 617px; height: 1484px; margin-left: 0px;"><div class="ace_layer ace_print-margin-layer"><div class="ace_print-margin" style="left: 564px; visibility: hidden;"></div></div><div class="ace_layer ace_marker-layer"><div class="ace_active-line" style="height:28px;top:56px;left:0;right:0;"></div></div><div class="ace_layer ace_text-layer" style="padding: 0px 4px;"><div class="ace_line_group" style="height:28px"><div class="ace_line" style="height:28px"><span class="ace_markup ace_heading ace_2">##</span><span class="ace_heading"> Chargement de données par rapport au modèle qu'on souhaite éxecuter</span></div></div><div class="ace_line_group" style="height:56px"><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">Pour le modèle de concaténation de CNN1D et MLP, il faut recharger les données de CNN1D </span></div><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">afin de compiler le modèle. </span></div></div><div class="ace_line_group" style="height:56px"><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">Pour le modèle de concaténation de CNN2D et MLP, il faut recharger les données de </span></div><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">CNN2D.</span></div></div></div><div class="ace_layer ace_marker-layer"></div><div class="ace_layer ace_cursor-layer"><div class="ace_cursor" style="left: 200px; top: 56px; width: 7px; height: 28px;"></div></div></div></div><div class="ace_scrollbar ace_scrollbar-v" style="display: none; width: 20px; bottom: 0px;"><div class="ace_scrollbar-inner" style="width: 20px; height: 140px;"></div></div><div class="ace_scrollbar ace_scrollbar-h" style="display: none; height: 20px; left: 41px; right: 0px;"><div class="ace_scrollbar-inner" style="height: 20px; width: 613px;"></div></div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: hidden;"><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: visible;"></div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font-style: inherit; font-variant: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; font-family: inherit; overflow: visible;">XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX</div></div></div>
</div>
<div id="preview1" class="g-b g-b--t1of2 split split-preview" style="height: 496px;">
<div id="preview" class="preview-html" preview="" debounce="150"><h2 class="code-line" data-line-start="0" data-line-end="1"><a id="Chargement_de_donnes_par_rapport_au_modle_quon_souhaite_xecuter_0"></a>Chargement de données par rapport au modèle qu’on souhaite éxecuter</h2>
<p class="has-line-data" data-line-start="1" data-line-end="3">Pour le modèle de concaténation de CNN1D et MLP, il faut recharger les données de CNN1D afin de compiler le modèle.<br>
Pour le modèle de concaténation de CNN2D et MLP, il faut recharger les données de CNN2D.</p>
</div>
</div>
</div>
</div>
